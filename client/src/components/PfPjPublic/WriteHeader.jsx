...
export default function WriteHeader({
    ...
    const defaultWriteData = {
        project : {
            ...
            body : ['모집 마감일, 인원은 최초 작성 후 수정시 변경할 수 없습니다.','타이틀 이미지는 필수로 기입해야 하지만 일반 이미지는 선택사항입니다.','검색 키워드는 선택 입력 사항입니다.']
        },
        portfolio : {
            title : '포트폴리오 작성시 주의사항',
            body : ['댓글 허용시 달리는 모든 댓글은 작성자 본인이 지울 수 있습니다.','댓글 허용 여부는 최초 작성 후에도 수정이 가능합니다.','타이틀 이미지는 필수로 기입해야 하지만 일반 이미지는 선택사항입니다.','검색 키워드는 선택 입력 사항입니다.']
        }
    }
    ...
    const defaultEditData = {
        project : {
            ...
            body : ['수정을 완료하면 이후 수정 이전으로 복구할 수 없습니다.','타이틀 이미지는 필수로 기입해야 하지만 일반 이미지는 선택사항입니다.','검색 키워드는 선택 입력 사항입니다.']
        },
        portfolio : {
